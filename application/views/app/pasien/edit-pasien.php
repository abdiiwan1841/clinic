		...
		<div class="box-body mt-3">
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="form-group col-md-3 select2">
						<label>Agama</label>
					...
					<div class="form-group col-md-2">
						...
						<div class="form-group mt-2 Patient_Type" style="display:none;">
							<select name="Patient_Type" id="Patient_Type" class="form-control select2" style=" width:100% !important">
								...
								<option value="Hepatitis B" <?= ($pasien['Patient_Type'] == 'Hepatitis B') ? 'selected' : ''; ?>>Hepatitis B</option>
								<option value="Hepatitis C" <?= ($pasien['Patient_Type'] == 'Hepatitis C') ? 'selected' : ''; ?>>Hepatitis C</option>
								<option value="SIFILIS" <?= ($pasien['Patient_Type'] == 'SIFILIS') ? 'selected' : ''; ?>>SIFILIS</option>
								<option value="HIV" <?= ($pasien['Patient_Type'] == 'HIV') ? 'selected' : ''; ?>>HIV</option>
							</select>
						</div>
					</div>
					<div class="form-group col-md-3">
					...
					if (result.value) {
						...
						$.ajax({
							...
							success: function (res) {
								swal("Berhasil!", "Data pasien teredit!", "success");
